...
- Even more improved badge size scaling

## [1.10.1] - 2026-08-22

### Fixed

- Improved badge size scaling

## [1.10.0] - 2026-08-16

### Added

- Add feature to copy responses to clipboard
...
- Only show alerts when using keyboard shortcuts
- Tweaks to transition animations
...
- Add shortcut meta+enter to create room

### Changed

- Always unpause when setting mode
